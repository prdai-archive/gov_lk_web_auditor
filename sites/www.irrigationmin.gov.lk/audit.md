...
Probe 1: [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: Hostname mismatch, certificate is not valid for 'www.irrigationmin.gov.lk'. (_ssl.c:1032); TLS certificate does not match the hostname
...
| tls_browser_trusted | ❌ | Probe 1: [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: Hostname mismatch, certificate is not valid for 'www.irrigationmin.gov.lk'. (_ssl.c:1032) |
